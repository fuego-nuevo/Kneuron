...
School.hasMany(Cohort, { foreignKey: { name: 'cohort_id', allowNull: true }, onDelete: 'CASCADE' });
Cohort.belongsTo(School, { foreignKey: { name: 'cohort_id', allowNull: true }, onDelete: 'CASCADE' });
